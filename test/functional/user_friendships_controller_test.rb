...
class UserFriendshipsControllerTest < ActionController::TestCase
  context "#index" do
    ...
    context "when logged in" do
      setup do
        @friendship1 = create(:pending_user_friendship, user: users(:arkadiusz), friend: create(:user, first_name: 'Pending', last_name: 'Friend'))
        @friendship2 = create(:accepted_user_friendship, user: users(:arkadiusz), friend: create(:user, first_name: 'Active', last_name: 'Friend'))
        @friendship3 = create(:requested_user_friendship, user: users(:arkadiusz), friend: create(:user, first_name: 'Requested', last_name: 'Friend'))
        @friendship4 = user_friendships(:blocked_by_arkadiusz)
  ...
  context "#new" do
    ...
    context "when logged in" do
      ...
      should "assign a new user friendship to the currently logged in user" do
        get :new, friend_id: users(:jim)
        assert_equal users(:arkadiusz), assigns(:user_friendship).user
      end
    ...
    context "when logged in" do
      ...
      context "with a valid friend_id" do
        ...
        should "set the flash success message" do
          ...
          assert_equal "Friendship created.", flash[:success]
        end
      end
    end
  end
  ...
  context "#accept" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:pending_user_friendship, user: users(:arkadiusz), friend: @friend)
        create(:pending_user_friendship, friend: users(:arkadiusz), user: @friend)
        sign_in users(:arkadiusz)
  ...
  context "#edit" do
    ...
    context "when logged in" do
      setup do
        @user_friendship = create(:pending_user_friendship, user: users(:arkadiusz))
        sign_in users(:arkadiusz)
  ...
  context "#destroy" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:accepted_user_friendship, friend: @friend, user: users(:arkadiusz))
        create(:accepted_user_friendship, friend: users(:arkadiusz), user: @friend)
